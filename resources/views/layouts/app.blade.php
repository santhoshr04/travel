...
<head>
    ...
    <title>Sim Airforce | Powered by iCrew™</title>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ asset('template/assets/images/fav.png') }}" type="image/x-icon">
    <!-- Swiper CSS -->
    <link rel="stylesheet" href="{{ asset('template/assets/css/swiper.min.css') }}">
    <!-- Lightcase CSS -->
    <link rel="stylesheet" href="{{ asset('template/assets/css/lightcase.css') }}">
    <!-- Odometer CSS -->
    <link rel="stylesheet" href="{{ asset('template/assets/css/odometer.css') }}">
    <!-- Icomoon CSS -->
...
<!-- Lightcase JS -->
<script src="{{ asset('template/assets/js/lightcase.js') }}"></script>
<!-- Odometer JS -->
<script src="{{ asset('template/assets/js/odometer.min.js') }}"></script>
<!-- Viewport JS -->
<script src="{{ asset('template/assets/js/viewport.jquery.js') }}"></script>
<!-- Progress JS -->
<script src="{{ asset('template/assets/js/circle-progress.min.js') }}"></script>
<!-- AOS JS -->
<script src="{{ asset('template/assets/js/aos.js') }}"></script>
<!-- Nice Select JS -->
<script src="{{ asset('template/assets/js/jquery.nice-select.js') }}"></script>
<!-- Main JS -->
